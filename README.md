...
![version](https://img.shields.io/badge/version-1.0.0--alpha.1-blue.svg)
...
- Polling-Intervall: 30 Sekunden (Cloud-Limit: 1 Anfrage/Sekunde)
...
- Keine Echtzeit-Updates – Werte werden alle 30 Sekunden abgerufen
